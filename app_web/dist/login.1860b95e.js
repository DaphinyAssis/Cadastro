...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/login.js":[function(require,module,exports) {
"use strict";
...
$(document).ready(function () {
  _axios.default.get(url + 'profiles', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#selectP').append($("<option></option>").attr("value", item.id).text(item.description));
    });

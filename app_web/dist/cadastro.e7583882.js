...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/cadastro.js":[function(require,module,exports) {
"use strict";
...
function Loadselect() {
  _axios.default.get(url + 'users', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#selectU').append($("<option></option>").attr("value", item.id).text(item.name));
    });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/cadastro.js"], null)
//# sourceMappingURL=/cadastro.e7583882.js.map
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"js/paginaproduct.js":[function(require,module,exports) {
"use strict";
...
function Loadselect() {
  _axios.default.get(url + 'products', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#selectP1').append($("<option></option>").attr("value", item.id).text(item.name));
    });
  ...
  _loadUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.get(url + 'products/' + id, {}).then(function (response) {
  ...
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return _axios.default.post(url + 'products', {
            id: $("#id").val(),
            name: $("#name").val(),
            code: $("#code").val(),
            price: $("#price").val(),
  ...
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(id) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return _axios.default.delete(url + 'products/' + id, {}).then(function (response) {
  ...
  _update = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return _axios.default.put(url + 'products', {
            id: $("#id").val(),
            name: $("#name").val(),
            code: $("#code").val(),
            price: $("#price").val(),
...
function clear() {
  $("#id").val(""), $("#name").val(""), $("#code").val(""), $("#price").val(""), $("#category").val("");
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/paginaproduct.js"], null)
//# sourceMappingURL=/paginaproduct.adf6e5fb.js.map